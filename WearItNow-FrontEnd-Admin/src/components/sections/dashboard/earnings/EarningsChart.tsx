...
type EarningsChartProps = {
  ...
  sx?: SxProps;
  profitPercentage: number; // Nhận profitPercentage từ Earnings component
};
...
const EarningsChart = ({ chartRef, profitPercentage, ...rest }: EarningsChartProps): ReactElement => {
  ...
  const option: EarningsChartOptions = useMemo(
    ...
    [profitPercentage, theme], // Cập nhật khi profitPercentage thay đổi
  );
